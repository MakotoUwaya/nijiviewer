...
- npm で配信されている Snowpack の最新版は v3.8.8(2022-01-22 現在)
...
- Jest の config ファイルから require を削除して、transform など必要な箇所のみコピー
  - `babelTransform.js` `fileTransform.js` `importMetaBabelPlugin.js` の 3 ファイルをコピーした
...
2021 年 10 月以降リリースも無く、コードもほとんど動いていない
